...
While the Arab Spring raised hopes for democratic transformation, the outcomes were largely disappointing. Tunisia was the only country to achieve a lasting democratic transition (until 2021). Egypt saw a brief democratic period before a military coup. Libya, Syria, and Yemen descended into civil wars.`
  },
  {
    id: 'fukushima',
    date: '2011-03-11',
...
The Fukushima disaster had far-reaching consequences for nuclear energy policy worldwide. Germany accelerated its nuclear phase-out, and several countries reconsidered their nuclear programs.`
  },
  {
    ...
    description: `The Syrian Civil War began in March 2011 when the Assad regime violently suppressed peaceful Arab Spring protests. The conflict rapidly escalated into a multi-sided civil war involving the Syrian government (backed by Russia and Iran), various rebel groups, Kurdish forces, and ISIS.
...
The Assad regime, with crucial military support from Russia and Iran-backed militias, gradually reclaimed most territory. Assad was ultimately overthrown in December 2024.`
  },
  {
    id: 'bin-laden-killed',
    date: '2011-05-02',
    ...
    description: `On May 2, 2011, U.S. Navy SEALs killed al-Qaeda leader Osama bin Laden during a raid on his compound in Abbottabad, Pakistan. The operation, codenamed Neptune Spear, was authorized by President Barack Obama after months of intelligence work.
...
The killing of bin Laden was a symbolic milestone but not a strategic endpoint in the War on Terror.`
  },
  {
    id: 'isis-rise',
    date: '2014-06-29',
    ...
    description: `On June 29, 2014, the Islamic State of Iraq and Syria (ISIS) declared a worldwide caliphate. ISIS had rapidly conquered large swaths of territory in Iraq and Syria, including Mosul, Iraq's second-largest city.
...
A U.S.-led coalition gradually reclaimed ISIS territory. Mosul was liberated in July 2017, and the last ISIS territorial holdout fell in March 2019.`
  },
  {
    id: 'paris-attacks',
    date: '2015-11-13',
    ...
    description: `On November 13, 2015, coordinated terrorist attacks struck multiple locations across Paris, killing 130 people and injuring over 400. The attackers, affiliated with ISIS, carried out shootings and suicide bombings at the Bataclan concert hall, the Stade de France, and several restaurants.

The Paris attacks were the deadliest in France since World War II and prompted President Hollande to declare a state of emergency that lasted nearly two years.`
  },
  {
    id: 'climate-paris',
    date: '2015-12-12',
    ...
    description: `The Paris Agreement, adopted on December 12, 2015, was a landmark international treaty on climate change. Nearly 200 countries agreed to limit global warming to well below 2°C above pre-industrial levels.

The agreement represented a breakthrough after decades of failed climate negotiations. However, most countries' commitments remain insufficient to meet the temperature targets.`
  },
  {
    id: 'brexit',
    date: '2016-06-23',
    ...
    description: `On June 23, 2016, the United Kingdom voted 52% to 48% to leave the European Union. The "Leave" campaign argued for national sovereignty and immigration control. Brexit was formally completed on January 31, 2020, after years of contentious negotiations.

The economic impact has included trade disruptions, reduced foreign investment, and labor shortages. Brexit inspired populist and Eurosceptic movements across Europe.`
  },
  {
    id: 'trump-election',
    date: '2016-11-08',
...
Trump's populist message resonated with working-class voters who felt left behind by globalization. His presidency was among the most polarizing in American history, marked by two impeachments, the COVID-19 pandemic response, and culminating in the January 6, 2021 Capitol attack.`
  },
  {
    id: 'covid-19',
    date: '2020-03-11',
    ...
    description: `The COVID-19 pandemic, caused by the SARS-CoV-2 coronavirus first identified in Wuhan, China, became the most significant global health crisis in a century. The WHO declared it a pandemic on March 11, 2020.

The pandemic killed over 7 million people officially, triggered the worst recession since the Great Depression, and fundamentally changed how billions of people live and work. Vaccines were developed with unprecedented speed.`
  },
  {
    id: 'george-floyd',
    date: '2020-05-25',
    ...
    description: `On May 25, 2020, George Floyd was murdered by a Minneapolis police officer, sparking the largest protest movement in American history. An estimated 15–26 million people participated in Black Lives Matter protests across all 50 states and in over 60 countries.

Chauvin was convicted of murder in April 2021. The movement led to some police reforms and a broader reckoning with racial inequality.`
  },
  {
    id: 'jan-6-capitol',
    date: '2021-01-06',
    ...
    description: `On January 6, 2021, a mob of Trump supporters stormed the United States Capitol building in an attempt to prevent the certification of Joe Biden's presidential election victory. The attack resulted in five deaths, 140 injured police officers, and extensive damage.

The January 6 attack was widely described as the most serious assault on American democratic institutions since the Civil War. Over 1,200 people were subsequently charged with crimes.`
  },
  {
    id: 'ukraine-russia',
    date: '2022-02-24',
    ...
    description: `On February 24, 2022, Russia launched a full-scale invasion of Ukraine, the largest military attack in Europe since World War II. Ukrainian forces mounted a fierce resistance that stalled the advance on Kyiv.

The war has caused tens of thousands of casualties, displaced millions of Ukrainians, triggered a global energy crisis, and fundamentally reshaped European security. It led to Finland and Sweden joining NATO.`
  }
];

// Conflict group definitions for sub-timeline views
export const conflictGroups = {
  'wwi': { label: 'World War I', dateRange: [1914, 1919] },
  'wwii': { label: 'World War II', dateRange: [1939, 1945] },
  'cold-war': { label: 'The Cold War', dateRange: [1947, 1991] },
  'arab-israeli': { label: 'Arab-Israeli Conflict', dateRange: [1948, 2025] },
  'war-on-terror': { label: 'War on Terror', dateRange: [2001, 2025] }
};
